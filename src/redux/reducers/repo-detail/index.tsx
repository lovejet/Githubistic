...
>("repoList/fetchRepoDetail", async (url: string, thunkApi) => {
...
export const repoDetail = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchRepoDetail.fulfilled, (state, { payload }) => {
      state.data = payload;
      state.status = "idle";
    });
    builder.addCase(fetchRepoDetail.rejected, (state, { payload }) => {
