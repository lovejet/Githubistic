...
import {
  ...
  reseRepoDetail,
  selectRepoDetail,
} from "@redux-reducers/repo-detail";
...
const RepoDetail = () => {
  ...
  useEffect(() => {
    const api_url = API_GITHUB_REPO_DETAIL_URL.replace("%1", user).replace(
      "%2",
      repo
    );
    ...
    return (
      <RepoInfoContainer>
        ...
        <Row>
          ...
          <Field>
            <ExternalLink href={repoDetail.data?.owner.html_url ?? ""}>
              <Text
                text={repoDetail.data?.owner.login}
                textSize="heading-4"
                textColor={color.text.light}
              />
            </ExternalLink>
        ...
        <Row>
          ...
          <Field>
            <Text
              text={repoDetail.data?.description}
              textSize="heading-4"
              textColor={color.text.light}
            />
          </Field>
          ...
          <Field>
            <Text
              text={getFormattedDateTime(
                new Date(repoDetail.data?.created_at ?? "")
              )}
              textSize="heading-4"
              textColor={color.text.light}
            />
        ...
        <Row>
          ...
          <Field>
            <Text
              text={getFormattedDateTime(
                new Date(repoDetail.data?.updated_at ?? "")
              )}
              textSize="heading-4"
              textColor={color.text.light}
            />
        ...
        <Row>
          ...
          <Field>
            <Text
              text={(repoDetail.data?.size ?? 0).toString()}
              textSize="heading-4"
              textColor={color.text.light}
            />
          </Field>
        ...
        <Row>
          ...
          <Field>
            <Text
              text={(repoDetail.data?.stargazers_count ?? 0).toString()}
              textSize="heading-4"
              textColor={color.text.light}
            />
          </Field>
        ...
        <Row>
          ...
          <Field>
            <Text
              text={(repoDetail.data?.forks_count ?? 0).toString()}
              textSize="heading-4"
              textColor={color.text.light}
            />
          </Field>
        ...
        <Row>
          ...
          <Field>
            <Text
              text={(repoDetail.data?.watchers_count ?? 0).toString()}
              textSize="heading-4"
              textColor={color.text.light}
            />
          </Field>
        ...
        <Row>
          ...
          <Field>
            <Text
              text={(repoDetail.data?.open_issues_count ?? 0).toString()}
              textSize="heading-4"
              textColor={color.text.light}
            />
          </Field>
