...
const LanguageFilterBox = () => {
  ...
  const [filterOptionsIndex, setFilterOptionsIndex] = useState(
    searchQuery.filterOptions.index
  );
  ...
  return (
    <LanguageFilterBoxContainer>
      ...
      >
        ...
        {LANGUGAE_FILTER_OPTIONS.map(
          (option: INTERFACE_FILTER_OPTIONS, index: number) => (
